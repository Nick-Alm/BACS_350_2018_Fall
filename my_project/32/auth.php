...
*/
    ...
    function register_user($db, $email, $pass, $first, $last) {
        //$email    = filter_input(INPUT_POST, 'email');
        //$password = filter_input(INPUT_POST, 'password');
        //$first    = filter_input(INPUT_POST, 'first');
        //$last     = filter_input(INPUT_POST, 'last');
        
        //echo "<p>$email , $pass , $first , $last</p>";

        //global $log;
        //$log->log("$email, $first, $last");
        $hash = password_hash($pass, PASSWORD_DEFAULT);
        
        $query = 'INSERT INTO administrators (email, pass, firstName, lastName) 
    ...
    function validate ($db, $email, $pass) {
        ...
        //global $log;
        //$log->log("Validate: $email, $pass");
        if (is_valid_login ($db, $email, $pass)) {
            $_SESSION['USER'] = $email;
        }
    }
